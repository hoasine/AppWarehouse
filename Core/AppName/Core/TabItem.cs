...
namespace AppName.Core
{
    ...
    public class TabItem : TemplatedView
    {
        ...
        public static readonly BindableProperty IconImageColorProperty = BindableProperty.Create("IconImageColor", typeof(Color), typeof(TabItem), Color.Black, BindingMode.OneWay, null, OnSelectionDependentPropertyChanged);
        ...
        public static readonly BindableProperty IconImageColorSelectedProperty = BindableProperty.Create("IconImageColorSelected", typeof(Color), typeof(TabItem), Color.Default, BindingMode.OneWay, null, OnSelectionDependentPropertyChanged);
        ...
        private static readonly BindablePropertyKey CurrentIconImageColorPropertyKey = BindableProperty.CreateReadOnly("CurrentIconImageColor", typeof(Color), typeof(TabItem), Color.Black);

        public static readonly BindableProperty CurrentIconImageColorProperty = CurrentIconImageColorPropertyKey.BindableProperty;
        ...
        public Color IconImageColor
        {
            get
            {
                return (Color)GetValue(IconImageColorProperty);
            }
            set
            {
                SetValue(IconImageColorProperty, value);
            }
        }
        ...
        public Color IconImageColorSelected
        {
            get
            {
                return (Color)GetValue(IconImageColorSelectedProperty);
            }
            set
            {
                SetValue(IconImageColorSelectedProperty, value);
            }
        }
        ...
        public Color CurrentIconImageColor
        {
            get
            {
                return (Color)GetValue(CurrentIconImageColorProperty);
            }
            private set
            {
                SetValue(CurrentIconImageColorPropertyKey, value);
            }
        }
        ...
        private void UpdateCurrentIcons()
        {
            ...
            CurrentIconImageColor = ((!IsSelected || IconImageColorSelected == Color.Default) ? IconImageColor : IconImageColorSelected);
