...
public class PrinterManagerActivity : AppCompatActivity
{
    private static string TAG = "PrinterManagerActivity";

    private EditText printInfo;   //Info to print

    PrinterManager mPrinterManager;

    private static String[] mBarTypeTable = {
    "3", "20", "25",
            "29", "34", "55", "58",
            "71", "84", "92",
    };
    ...
    private static int DEF_PRINTER_HUE_VALUE = 0;
    private static int MIN_PRINTER_HUE_VALUE = 0;
    private static int MAX_PRINTER_HUE_VALUE = 4;

    //Print value 0-9
    private static int DEF_PRINTER_SPEED_VALUE = 9;
    private static int MIN_PRINTER_SPEED_VALUE = 0;
    private static int MAX_PRINTER_SPEED_VALUE = 9;

    // Printtus
    private static int PRNSTS_OK = 0;
    private static int PRNSTS_OUT_OF_PAPER = -1;
    private static int PRNSTS_OVER_HEAT = -2;
    private static int PRNSTS_UNDER_VOLTAGE = -3;
    private static int PRNSTS_BUSY = -4;
    private static int PRNSTS_ERR = -256;
    private static int PRNSTS_ERR_DRIVER = -257;
...
private static int PHOTO_REQUEST_CODE = 200;
...
Looper.loop();   //4.Start message loop
    ...
    private void updatePrintStatus(int status)
{
