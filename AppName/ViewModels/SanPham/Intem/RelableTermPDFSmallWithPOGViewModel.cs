...
namespace AppName
{
    public class RelableTermPDFSmallWithPOGViewModel : BaseViewModel
    {
        ...
        public RelableTermPDFSmallWithPOGViewModel(INavigation navigation)
        {
        ...
        public async void LoadData()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Uri uri = new Uri(RealmHelper.Instance.All<UserLSRetailConfig>().FirstOrDefault().URLApi + "/api/Products/ProductInfoPrintTagWithPOG?Store=" + userstore
                        + "&pog=" + Uri.EscapeDataString(SelectedPOG.POG)
                        + "&datePrinter=" + DatePrinter.ToString("yyyy-MM-dd")
