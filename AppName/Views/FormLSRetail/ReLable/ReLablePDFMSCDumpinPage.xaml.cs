...
namespace AppName
{
    public partial class ReLablePDFMSCDumpinPage : ContentPage
    {
        ...
        typeof(ReLablePDFMSCDumpinPage),
        null);

        RelableTermPDFMSCDumpinViewModel viewModel;

        #endregion

        public ReLablePDFMSCDumpinPage()
        {
            InitializeComponent();

            BindingContext = viewModel = new RelableTermPDFMSCDumpinViewModel(Navigation);
        }
