...
namespace AppName
{
    public partial class ReLablePDFSmallWithPromotionPage : ContentPage
    {
        ...
        RelableTermPDFSmallWithPromotionViewModel viewModel;

        #endregion

        public ReLablePDFSmallWithPromotionPage()
        {
            InitializeComponent();

            BindingContext = viewModel = new RelableTermPDFSmallWithPromotionViewModel(Navigation);
        }
