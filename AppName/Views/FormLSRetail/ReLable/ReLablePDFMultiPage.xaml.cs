...
namespace AppName
{
    public partial class ReLablePDFMultiPage : ContentPage
    {
        ...
        typeof(ReLablePDFMultiPage),
        null);

        RelableTermPDFMultiViewModel viewModel;

        #endregion

        public ReLablePDFMultiPage()
        {
            InitializeComponent();

            BindingContext = viewModel = new RelableTermPDFMultiViewModel(Navigation);
        }
