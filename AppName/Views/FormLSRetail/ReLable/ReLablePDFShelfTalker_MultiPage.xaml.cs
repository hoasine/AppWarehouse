...
namespace AppName
{
    public partial class ReLablePDFShelfTalker_MultiPage : ContentPage
    {
        ...
        typeof(ReLablePDFShelfTalker_MultiPage),
        null);

        ReLablePDFShelfTalkerMultiViewModel viewModel;

        #endregion

        public ReLablePDFShelfTalker_MultiPage()
        {
            InitializeComponent();

            BindingContext = viewModel = new ReLablePDFShelfTalkerMultiViewModel(Navigation);
        }
