...
namespace AppName
{
    public partial class ReLablePDFSmallWithPOGPage : ContentPage
    {
        ...
        RelableTermPDFSmallWithPOGViewModel viewModel;

        #endregion

        public ReLablePDFSmallWithPOGPage()
        {
            InitializeComponent();

            BindingContext = viewModel = new RelableTermPDFSmallWithPOGViewModel(Navigation);
        }
