...
namespace AppName
{
    public partial class ReLablePDFShelfTalkerPage : ContentPage
    {
        ...
        typeof(ReLablePDFShelfTalkerPage),
        null);

        ReLablePDFShelfTalkerViewModel viewModel;

        #endregion

        public ReLablePDFShelfTalkerPage()
        {
            InitializeComponent();

            BindingContext = viewModel = new ReLablePDFShelfTalkerViewModel(Navigation);
        }
