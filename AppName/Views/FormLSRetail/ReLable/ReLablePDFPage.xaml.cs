...
namespace AppName
{
    public partial class ReLablePDFPage : ContentPage
    {
        ...
        typeof(ReLablePDFPage),
        null);

        RelableTermPDFViewModel viewModel;

        #endregion

        public ReLablePDFPage()
        {
            InitializeComponent();

            BindingContext = viewModel = new RelableTermPDFViewModel(Navigation);
        }
