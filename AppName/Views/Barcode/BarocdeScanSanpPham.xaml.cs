...
namespace AppName
{
    public partial class BarocdeScanSanpPham : ContentPage
    {
        ...
        void TimKiem_Click(object sender, EventArgs e)
        {
            ...
            {
                var dialog = new NotificationWarrningPopup(this.GetType().Name, CheckConnectInternet.GetmethodName()) { Message = "Please enter barcode." };
                PopupNavigation.Instance.PushAsync(dialog);
            }
        }
